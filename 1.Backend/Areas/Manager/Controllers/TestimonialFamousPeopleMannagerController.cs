...
{
    [Area("Manager")]
    public class TestimonialFamousPeopleMannagerController : Base.Controllers.BaseController
    {

        private readonly ILogger _logger;
        private readonly IContactRepository _iContactRepository;

        public TestimonialFamousPeopleMannagerController(
            ILogger<TestimonialFamousPeopleMannagerController> logger,
                ...
                limit ?? 10,
                    ...
                    && (m.Status == status || status == null)
                     && (m.IsHome == isHome || isHome == null)
                        && m.Type==Contact.ContactType.FamousPeople && 
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    var data = new Contact
                    {
                        ...
                        IsHome = use.IsHome,
                        Avatar = use.Avatar,
                        Type = Contact.ContactType.FamousPeople,
