 ...
 */
!function(n,t){var u=function(i,r){var e,c,u=this,y,o,l,k,p,f,w,a,v;r=r||{};this.$element=n(i);this.options=n.extend(!0,{},n.fn.ajaxSelectPicker.defaults,r);this.LOG_ERROR=1;this.LOG_WARNING=2;this.LOG_INFO=3;this.LOG_DEBUG=4;this.lastRequest=!1;this.previousQuery="";this.query="";this.request=!1;y=[{from:"ajaxResultsPreHook",to:"preprocessData"},{from:"ajaxSearchUrl",to:{ajax:{url:"{{{value}}}"}}},{from:"ajaxOptions",to:"ajax"},{from:"debug",to:function(t){var i={};i.log=Boolean(u.options[t.from])?u.LOG_DEBUG:0;u.options=n.extend(!0,{},u.options,i);delete u.options[t.from];u.log(u.LOG_WARNING,'Deprecated option "'+t.from+'". Update code to use:',i)}},{from:"mixWithCurrents",to:"preserveSelected"},{from:"placeHolderOption",to:{locale:{emptyTitle:"{{{value}}}"}}}];y.length&&n.map(y,function(t){if(u.options[t.from])if(n.isPlainObject(t.to))u.replaceValue(t.to,"{{{value}}}",u.options[t.from]),u.options=n.extend(!0,{},u.options,t.to),u.log(u.LOG_WARNING,'Deprecated option "'+t.from+'". Update code to use:',t.to),delete u.options[t.from];else if(n.isFunction(t.to))t.to.apply(u,[t]);else{var i={};i[t.to]=u.options[t.from];u.options=n.extend(!0,{},u.options,i);u.log(u.LOG_WARNING,'Deprecated option "'+t.from+'". Update code to use:',i);delete u.options[t.from]}});o=this.$element.data();o.searchUrl&&(u.log(u.LOG_WARNING,'Deprecated attribute name: "data-search-url". Update markup to use: \' data-abs-ajax-url="'+o.searchUrl+"\" '"),this.options.ajax.url=o.searchUrl);var nt=function(n,t){return t.toLowerCase()},b=function(n,t,i){var r=[].concat(n),e=r.length,u=i||{},f;return e&&(f=r.shift(),u[f]=b(r,t,u[f])),e?u:t},h=Object.keys(o).filter(/./.test.bind(new RegExp("^abs[A-Z]")));if(h.length){for(l={},k=["locale"],e=0,c=h.length;e<c;e++){if(p=h[e].replace(/^abs([A-Z])/,nt).replace(/([A-Z])/g,"-$1").toLowerCase(),f=p.split("-"),f[0]&&f.length>1&&k.indexOf(f[0])!==-1){for(var d=[f.shift()],g="",s=0;s<f.length;s++)g+=0===s?f[s]:f[s].charAt(0).toUpperCase()+f[s].slice(1);d.push(g);f=d}this.log(this.LOG_DEBUG,'Processing data attribute "data-abs-'+p+'":',o[h[e]]);b(f,o[h[e]],l)}this.options=n.extend(!0,{},this.options,l);this.log(this.LOG_DEBUG,"Merged in the data attribute options: ",l,this.options)}if(this.selectpicker=o.selectpicker,!this.selectpicker)return this.log(this.LOG_ERROR,"Cannot instantiate an AjaxBootstrapSelect instance without selectpicker first being initialized!"),null;if(!this.options.ajax.url)return this.log(this.LOG_ERROR,'Option "ajax.url" must be set! Options:',this.options),null;if(this.locale=n.extend(!0,{},n.fn.ajaxSelectPicker.locale),this.options.langCode=this.options.langCode||t.navigator.userLanguage||t.navigator.language||"en",!this.locale[this.options.langCode]){for(w=this.options.langCode,this.options.langCode="en",a=w.split("-"),e=0,c=a.length;e<c;e++){if(v=a.join("-"),v.length&&this.locale[v]){this.options.langCode=v;break}a.pop()}this.log(this.LOG_WARNING,'Unknown langCode option: "'+w+'". Using the following langCode instead: "'+this.options.langCode+'".')}this.locale[this.options.langCode]=n.extend(!0,{},this.locale[this.options.langCode],this.options.locale);this.list=new t.AjaxBootstrapSelectList(this);this.list.refresh();setTimeout(function(){u.init()},500)},i,r;u.prototype.init=function(){var r,i=this;this.options.preserveSelected&&this.selectpicker.$menu.off("click",".actions-btn").on("click",".actions-btn",function(t){i.selectpicker.options.liveSearch?i.selectpicker.$searchbox.focus():i.selectpicker.$button.focus();t.preventDefault();t.stopPropagation();n(this).is(".bs-select-all")?(null===i.selectpicker.$lis&&(i.selectpicker.$lis=i.selectpicker.$menu.find("li")),i.$element.find("option:enabled").prop("selected",!0),n(i.selectpicker.$lis).not(".disabled").addClass("selected"),i.selectpicker.render()):(null===i.selectpicker.$lis&&(i.selectpicker.$lis=i.selectpicker.$menu.find("li")),i.$element.find("option:enabled").prop("selected",!1),n(i.selectpicker.$lis).not(".disabled").removeClass("selected"),i.selectpicker.render());i.selectpicker.$element.change()});this.selectpicker.$searchbox.attr("placeholder",this.t("searchPlaceholder")).off("input propertychange");this.selectpicker.$searchbox.on(this.options.bindEvent,function(u){var e=i.selectpicker.$searchbox.val(),f;if(i.log(i.LOG_DEBUG,'Bind event fired: "'+i.options.bindEvent+'", keyCode:',u.keyCode,u),i.options.cache||(i.options.ignoredKeys[13]="enter"),i.options.ignoredKeys[u.keyCode])return void i.log(i.LOG_DEBUG,"Key ignored.");if(e.length<i.options.minLength)return void i.list.setStatus(i.t("statusTooShort"));if(clearTimeout(r),e.length||(i.options.clearOnEmpty&&i.list.destroy(),i.options.emptyRequest)){if((i.previousQuery=i.query,i.query=e,i.options.cache&&13!==u.keyCode)&&(f=i.list.cacheGet(i.query),f))return i.list.setStatus(f.length?"":i.t("statusNoResults")),i.list.replaceOptions(f),void i.log(i.LOG_INFO,"Rebuilt options from cached data.");r=setTimeout(function(){i.lastRequest&&i.lastRequest.jqXHR&&n.isFunction(i.lastRequest.jqXHR.abort)&&i.lastRequest.jqXHR.abort();i.request=new t.AjaxBootstrapSelectRequest(i);i.request.jqXHR.always(function(){i.lastRequest=i.request;i.request=!1})},i.options.requestDelay||300)}})};u.prototype.log=function(n,i){var r,u;if(t.console&&this.options.log){if("number"!=typeof this.options.log)switch("string"==typeof this.options.log&&(this.options.log=this.options.log.toLowerCase()),this.options.log){case!0:case"debug":this.options.log=this.LOG_DEBUG;break;case"info":this.options.log=this.LOG_INFO;break;case"warn":case"warning":this.options.log=this.LOG_WARNING;break;default:case!1:case"error":this.options.log=this.LOG_ERROR}if(n<=this.options.log){r=[].slice.apply(arguments,[2]);switch(n){case this.LOG_DEBUG:n="debug";break;case this.LOG_INFO:n="info";break;case this.LOG_WARNING:n="warn";break;default:case this.LOG_ERROR:n="error"}u="["+n.toUpperCase()+"] AjaxBootstrapSelect:";"string"==typeof i?r.unshift(u+" "+i):(r.unshift(i),r.unshift(u));t.console[n].apply(t.console,r)}}};u.prototype.replaceValue=function(t,i,r,u){var f=this;u=n.extend({recursive:!0,depth:!1,limit:!1},u);n.each(t,function(e,o){return!(u.limit!==!1&&"number"==typeof u.limit&&u.limit<=0)&&void(n.isArray(t[e])||n.isPlainObject(t[e])?(u.recursive&&u.depth===!1||u.recursive&&"number"==typeof u.depth&&u.depth>0)&&f.replaceValue(t[e],i,r,u):o===i&&(u.limit!==!1&&"number"==typeof u.limit&&u.limit--,t[e]=r))})};u.prototype.t=function(n,t){return t=t||this.options.langCode,this.locale[t]&&this.locale[t].hasOwnProperty(n)?this.locale[t][n]:(this.log(this.LOG_WARNING,"Unknown translation key:",n),n)};t.AjaxBootstrapSelect=t.AjaxBootstrapSelect||u;i=function(t){var i=this,r,u;this.$status=n(t.options.templates.status).hide().appendTo(t.selectpicker.$menu);r=t.t("statusInitialized");r&&r.length&&this.setStatus(r);this.cache={};this.plugin=t;this.selected=[];this.title=null;this.selectedTextFormat=t.selectpicker.options.selectedTextFormat;u=[];t.$element.find("option").each(function(){var i=n(this),r=i.attr("value");u.push({value:r,text:i.text(),"class":i.attr("class")||"",data:i.data()||{},preserved:t.options.preserveSelected,selected:!!i.attr("selected")})});this.cacheSet("",u);t.options.preserveSelected&&(i.selected=u,t.$element.on("change.abs.preserveSelected",function(){var r=t.$element.find(":selected");i.selected=[];t.selectpicker.multiple||(r=r.last());r.each(function(){var t=n(this),r=t.attr("value");i.selected.push({value:r,text:t.text(),"class":t.attr("class")||"",data:t.data()||{},preserved:!0,selected:!0})});i.replaceOptions(i.cacheGet(i.plugin.query))}))};i.prototype.build=function(t){var u,f,h=t.length,e=n("<select/>"),o=n("<optgroup/>").attr("label",this.plugin.t("currentlySelected")),i,r,s;for(this.plugin.log(this.plugin.LOG_DEBUG,"Building the select list options from data:",t),f=0;f<h;f++)if(i=t[f],r=n("<option/>").appendTo(i.preserved?o:e),i.hasOwnProperty("divider"))r.attr("data-divider","true");else{r.val(i.value).text(i.text).attr("title",i.text);i.class.length&&r.attr("class",i.class);i.disabled&&r.attr("disabled",!0);i.selected&&!this.plugin.selectpicker.multiple&&e.find(":selected").prop("selected",!1);i.selected&&r.attr("selected",!0);for(u in i.data)i.data.hasOwnProperty(u)&&r.attr("data-"+u,i.data[u])}return o.find("option").length&&o["before"===this.plugin.options.preserveSelectedPosition?"prependTo":"appendTo"](e),s=e.html(),this.plugin.log(this.plugin.LOG_DEBUG,s),s};i.prototype.cacheGet=function(n,t){var i=this.cache[n]||t;return this.plugin.log(this.LOG_DEBUG,"Retrieving cache:",n,i),i};i.prototype.cacheSet=function(n,t){this.cache[n]=t;this.plugin.log(this.LOG_DEBUG,"Saving to cache:",n,t)};i.prototype.destroy=function(){this.replaceOptions();this.plugin.list.setStatus();this.plugin.log(this.plugin.LOG_DEBUG,"Destroyed select list.")};i.prototype.refresh=function(n){this.plugin.selectpicker.$menu.css("minHeight",0);this.plugin.selectpicker.$menu.find("> .inner").css("minHeight",0);var t=this.plugin.t("emptyTitle");!this.plugin.$element.find("option").length&&t&&t.length?this.setTitle(t):(this.title||"static"!==this.selectedTextFormat&&this.selectedTextFormat!==this.plugin.selectpicker.options.selectedTextFormat)&&this.restoreTitle();this.plugin.selectpicker.refresh();this.plugin.selectpicker.findLis();n&&(this.plugin.log(this.plugin.LOG_DEBUG,"Triggering Change"),this.plugin.$element.trigger("change.$"));this.plugin.log(this.plugin.LOG_DEBUG,"Refreshed select list.")};i.prototype.replaceOptions=function(n){var i,u,t,f="",e=[],r=[],o=[];if(n=n||[],this.selected&&this.selected.length){for(this.plugin.log(this.plugin.LOG_INFO,"Processing preserved selections:",this.selected),r=[].concat(this.selected,n),u=r.length,i=0;i<u;i++)t=r[i],t.hasOwnProperty("value")&&o.indexOf(t.value+"")===-1?(o.push(t.value+""),e.push(t)):this.plugin.log(this.plugin.LOG_DEBUG,"Duplicate item found, ignoring.");n=e}n.length&&(f=this.plugin.list.build(n));this.plugin.$element.html(f);this.refresh();this.plugin.log(this.plugin.LOG_DEBUG,"Replaced options with data:",n)};i.prototype.restore=function(){var n=this.plugin.list.cacheGet(this.plugin.previousQuery);return n&&this.plugin.list.replaceOptions(n)&&this.plugin.log(this.plugin.LOG_DEBUG,"Restored select list to the previous query: ",this.plugin.previousQuery),this.plugin.log(this.plugin.LOG_DEBUG,"Unable to restore select list to the previous query:",this.plugin.previousQuery),!1};i.prototype.restoreTitle=function(){this.plugin.request||(this.plugin.selectpicker.options.selectedTextFormat=this.selectedTextFormat,this.title?this.plugin.$element.attr("title",this.title):this.plugin.$element.removeAttr("title"),this.title=null)};i.prototype.setTitle=function(n){this.plugin.request||(this.title=this.plugin.$element.attr("title"),this.plugin.selectpicker.options.selectedTextFormat="static",this.plugin.$element.attr("title",n))};i.prototype.setStatus=function(n){n=n||"";n.length?this.$status.html(n).show():this.$status.html("").hide()};t.AjaxBootstrapSelectList=t.AjaxBootstrapSelectList||i;r=function(t){var u,i=this,e=function(n){return function(){i.plugin.log(i.plugin.LOG_INFO,"Invoking AjaxBootstrapSelectRequest."+n+" callback:",arguments);i[n].apply(i,arguments);i.callbacks[n]&&(i.plugin.log(i.plugin.LOG_INFO,"Invoking ajax."+n+" callback:",arguments),i.callbacks[n].apply(i,arguments))}},f=["beforeSend","success","error","complete"],o=f.length,r;for(this.plugin=t,this.options=n.extend(!0,{},t.options.ajax),this.callbacks={},u=0;u<o;u++)r=f[u],this.options[r]&&n.isFunction(this.options[r])&&(this.callbacks[r]=this.options[r]),this.options[r]=e(r);this.options.data&&n.isFunction(this.options.data)&&(this.options.data=this.options.data.apply(this)||{q:"{{{q}}}"});this.plugin.replaceValue(this.options.data,"{{{q}}}",this.plugin.query);this.options.url&&n.isFunction(this.options.url)&&(this.options.url=this.options.url.apply(this));this.jqXHR=n.ajax(this.options)};r.prototype.beforeSend=function(){this.plugin.list.destroy();this.plugin.list.setStatus(this.plugin.t("statusSearching"))};r.prototype.complete=function(n,t){if("abort"!==t){var i=this.plugin.list.cacheGet(this.plugin.query);if(i){if(!i.length)return this.plugin.list.destroy(),this.plugin.list.setStatus(this.plugin.t("statusNoResults")),void this.plugin.log(this.plugin.LOG_INFO,"No results were returned.");this.plugin.list.setStatus()}this.plugin.list.refresh(!0)}};r.prototype.error=function(n,t){"abort"!==t&&(this.plugin.list.cacheSet(this.plugin.query),this.plugin.options.clearOnError&&this.plugin.list.destroy(),this.plugin.list.setStatus(this.plugin.t("errorText")),this.plugin.options.restoreOnError&&(this.plugin.list.restore(),this.plugin.list.setStatus()))};r.prototype.process=function(t){var e,s,r,i,u,f,o=[],h=[];if(this.plugin.log(this.plugin.LOG_INFO,"Processing raw data for:",this.plugin.query,t),u=t,n.isFunction(this.plugin.options.preprocessData)&&(this.plugin.log(this.plugin.LOG_DEBUG,"Invoking preprocessData callback:",this.plugin.options.processData),r=this.plugin.options.preprocessData.apply(this,[u]),"undefined"!=typeof r&&null!==r&&r!==!1&&(u=r)),!n.isArray(u))return this.plugin.log(this.plugin.LOG_ERROR,'The data returned is not an Array. Use the "preprocessData" callback option to parse the results and construct a proper array for this plugin.',u),!1;for(s=u.length,e=0;e<s;e++)i=u[e],this.plugin.log(this.plugin.LOG_DEBUG,"Processing item:",i),n.isPlainObject(i)&&(i.hasOwnProperty("divider")||i.hasOwnProperty("data")&&n.isPlainObject(i.data)&&i.data.divider?(this.plugin.log(this.plugin.LOG_DEBUG,"Item is a divider, ignoring provided data."),o.push({divider:!0})):i.hasOwnProperty("value")?h.indexOf(i.value+"")===-1?(h.push(i.value+""),i=n.extend({text:i.value,"class":"",data:{},disabled:!1,selected:!1},i),o.push(i)):this.plugin.log(this.plugin.LOG_DEBUG,"Duplicate item found, ignoring."):this.plugin.log(this.plugin.LOG_DEBUG,'Data item must have a "value" property, skipping.'));if(f=[].concat(o),n.isFunction(this.plugin.options.processData)&&(this.plugin.log(this.plugin.LOG_DEBUG,"Invoking processData callback:",this.plugin.options.processData),r=this.plugin.options.processData.apply(this,[f]),"undefined"!=typeof r&&null!==r&&r!==!1)){if(!n.isArray(r))return this.plugin.log(this.plugin.LOG_ERROR,"The processData callback did not return an array.",r),!1;f=r}return this.plugin.list.cacheSet(this.plugin.query,f),this.plugin.log(this.plugin.LOG_INFO,"Processed data:",f),f};r.prototype.success=function(t){if(!n.isArray(t)&&!n.isPlainObject(t))return this.plugin.log(this.plugin.LOG_ERROR,"Request did not return a JSON Array or Object.",t),void this.plugin.list.destroy();var i=this.process(t);this.plugin.list.replaceOptions(i)};t.AjaxBootstrapSelectRequest=t.AjaxBootstrapSelectRequest||r;n.fn.ajaxSelectPicker=function(i){return this.each(function(){n(this).data("AjaxBootstrapSelect")||n(this).data("AjaxBootstrapSelect",new t.AjaxBootstrapSelect(this,i))})};n.fn.ajaxSelectPicker.locale={};n.fn.ajaxSelectPicker.defaults={ajax:{url:null,type:"POST",dataType:"json",data:{q:"{{{q}}}"}},minLength:0,bindEvent:"keyup",cache:!0,clearOnEmpty:!0,clearOnError:!0,emptyRequest:!1,ignoredKeys:{9:"tab",16:"shift",17:"ctrl",18:"alt",27:"esc",37:"left",39:"right",38:"up",40:"down",91:"meta"},langCode:null,locale:null,log:"error",preprocessData:function(){},preserveSelected:!0,preserveSelectedPosition:"after",processData:function(){},requestDelay:300,restoreOnError:!1,templates:{status:'<div class="status"><\/div>'}};n.fn.ajaxSelectPicker.locale["en-US"]={currentlySelected:"Currently Selected",emptyTitle:"Chọn",errorText:"Unable to retrieve results",searchPlaceholder:"Search...",statusInitialized:"Start typing a search query",statusNoResults:"No Results",statusSearching:"Searching...",statusTooShort:"Please enter more characters"};n.fn.ajaxSelectPicker.locale.en=n.fn.ajaxSelectPicker.locale["en-US"]}(jQuery,window);
