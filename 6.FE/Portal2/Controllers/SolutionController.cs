...
namespace PT.UI.Controllers
{
    public class SolutionController : Controller
    {
        ...
        public SolutionController(ILinkRepository iLinkRepository, IOptions<BaseSettings> baseSettings, IWebHostEnvironment iHostingEnvironment, IContentPageRepository iContentPageRepository, ILinkReferenceRepository iLinkReferenceRepository)
        {
