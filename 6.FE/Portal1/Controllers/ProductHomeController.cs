...
namespace PT.UI.Controllers
{
    public class ProductHomeController : Controller
    {
        ...
        public ProductHomeController(ILinkRepository iLinkRepository, IOptions<BaseSettings> baseSettings, IWebHostEnvironment iHostingEnvironment, IContentPageRepository iContentPageRepository, ILinkReferenceRepository iLinkReferenceRepository)
        {
